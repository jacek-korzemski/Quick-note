...
interface BoardCategoryEditorModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}
...
const BoardCategoryEditorModal: React.FC<BoardCategoryEditorModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      await boardCategoriesApi.create({
        name: trimmedName,
        parent_id: parentId,
      });
      handleClose();
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button type="submit" form="board-category-editor-form" variant="primary" loading={loading}>
            Utwórz
          </Button>
        </>
      }
    >
      <form id="board-category-editor-form" onSubmit={handleSubmit}>
...
export default BoardCategoryEditorModal;
